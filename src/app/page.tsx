  ...
  return (
    <>
      <Head>
        {/* Primary Meta Tags */}
        <title>
          Sylwester Pawlik - Licencjonowany Agent Nieruchomości Kielce |
          Sprzedaż, Kupno, Wynajem
        </title>
        <meta
          name="title"
          content="Sylwester Pawlik - Licencjonowany Agent Nieruchomości Kielce | Sprzedaż, Kupno, Wynajem"
        />
        <meta
          name="description"
          content="Sylwester Pawlik - doświadczony pośrednik nieruchomości w Kielcach. 8+ lat doświadczenia, 300+ zadowolonych klientów. Sprzedaż mieszkań i domów w 14 dni. Licencja PFRN 26546. Telefon 786-221-221"
        />
        <meta
          name="keywords"
          content="Sylwester Pawlik, agent nieruchomości Kielce, pośrednik nieruchomości Kielce, sprzedaż mieszkań Kielce, kupno domów Kielce, wynajem mieszkań Kielce, biuro nieruchomości Kielce, CKDom, licencjonowany pośrednik, nieruchomości świętokrzyskie"
        />
        <meta name="author" content="Sylwester Pawlik" />
        ...
        {/* Canonical URL */}
        <link rel="canonical" href="https://sylwesterpawlik.pl" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sylwesterpawlik.pl" />
        <meta
          property="og:title"
          content="Sylwester Pawlik - Licencjonowany Agent Nieruchomości Kielce"
        />
        <meta
          property="og:description"
          content="Doświadczony pośrednik nieruchomości w Kielcach. 8+ lat doświadczenia, średni czas sprzedaży: 14 dni. Sprzedaż, kupno i wynajem nieruchomości. Licencja PFRN 26546."
        />
        <meta
          property="og:image"
          content="https://sylwesterpawlik.pl/zdjecie-profilowe.jpg"
        />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta
          property="og:image:alt"
          content="Sylwester Pawlik - Agent nieruchomości Kielce"
        />
        <meta
          property="og:site_name"
          content="Sylwester Pawlik - Nieruchomości Kielce"
        />
        <meta property="og:locale" content="pl_PL" />

        {/* Twitter */}
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://sylwesterpawlik.pl" />
        <meta
        ...
        <meta
          ...
          content="Licencjonowany pośrednik nieruchomości w Kielcach. 8+ lat doświadczenia, szybka sprzedaż w 14 dni. ☎️ 786-221-221"
        />
        <meta
        ...
        <meta name="geo.placename" content="Kielce" />
        <meta name="geo.position" content="50.8661;20.6286" />
        <meta name="ICBM" content="50.8661, 20.6286" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Sylwester Pawlik",
              image: "https://sylwesterpawlik.pl/zdjecie-profilowe.jpg",
              description:
                "Licencjonowany pośrednik nieruchomości w Kielcach z 8+ letnim doświadczeniem. Specjalizuje się w sprzedaży, kupnie i wynajmie nieruchomości.",
              telephone: "+48786221221",
              email: "biuro@ckdom.pl",
              url: "https://sylwesterpawlik.pl",
              address: {
                "@type": "PostalAddress",
                streetAddress: "Aleja Solidarności 5",
              ...
              hasCredential: {
                ...
                recognizedBy: "Polska Federacja Rynku Nieruchomości",
                name: "Licencja Pośrednika Nieruchomości",
                identifier: "PFRN 26546",
              },
              memberOf: {
                "@type": "Organization",
                name: "Świętokrzyskie Stowarzyszenie Pośredników w Obrocie Nieruchomości",
              },
              worksFor: {
                "@type": "RealEstateAgency",
                name: "CKDom",
                url: "https://www.ckdom.pl",
                address: {
                  "@type": "PostalAddress",
                  streetAddress: "Aleja Solidarności 5",
                  addressLocality: "Kielce",
                ...
                itemListElement: [
                  {
                    ...
                    itemOffered: {
                      ...
                      description:
                        "Profesjonalna sprzedaż mieszkań i domów w Kielcach",
                    },
                  },
                  {
                    "@type": "Offer",
                    itemOffered: {
                      "@type": "Service",
                      name: "Kupno nieruchomości",
                      description:
                        "Pomoc w zakupie mieszkań i domów w Kielcach",
                    },
                  },
                  {
                    "@type": "Offer",
                    itemOffered: {
                      ...
                      description: "Zarządzanie najmem mieszkań i domów",
                    },
                  },
                ],
              },
              ...
              review: [
                {
                  ...
                  reviewBody:
                    "Pan Sylwester sprzedał nasze mieszkanie w rekordowym czasie za cenę wyższą niż oczekiwaliśmy. Profesjonalizm na najwyższym poziomie!",
                },
              ],
              sameAs: [
                "https://www.facebook.com/biurokielce",
                "https://www.tiktok.com/@biurockdom",
                "https://www.ckdom.pl",
              ],
            }),
          }}
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-white order-2 lg:order-1">
                ...
                <p className="text-lg sm:text-xl mb-6 sm:mb-8 text-slate-200 leading-relaxed">
                  Ponad 8 lat doświadczenia • 300+ zadowolonych klientów •
                  Średni czas sprzedaży: 14 dni
                </p>
              ...
              <div>
                ...
                <div className="space-y-4 sm:space-y-6 text-slate-700">
                  <p className="text-base sm:text-lg leading-relaxed text-justify">
                    ...
                    pośrednikiem nieruchomości z ponad 8-letnim doświadczeniem
                    na rynku kieleckim. Specjalizuję się w sprzedaży, kupnie i
                    wynajmie nieruchomości w Kielcach i okolicach. Jednym z
                    moich największych atutów jest bardzo wysoka skuteczność,
                    będąca efektem połączenia dwudziestoletniego doświadczenia w
                  ...
                  <p className="text-base sm:text-lg leading-relaxed text-justify">
                    Członek Świętokrzyskiego Stowarzyszenia Pośredników w
                    Obrocie Nieruchomości. Jestem rekomendowanym fotografem
                    wirtualnych spacerów. Ponad 22 lat zdobywam doświadczenie w
                    handlu i obsłudze Klienta. Mam ponad 8 lat doświadczenia w
                    branży pośrednictwa w obrocie nieruchomościami. Specjalizuje
                    się w szybkiej sprzedaży mieszkań, domów, działek, dzięki
                    trafnemu nowoczesnemu marketingowi i współpracy z
                    większością Pośredników nieruchomości w kraju. Sprzedaż
                    nieruchomości to proces wymagający wielu czynności,
                    umiejętności i czasu. W swojej pracy dążę do maksymalnego
                    odciążenia moich klientów, gwarantując pewność i spokój na
                    każdym kroku.
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="flex flex-col items-center bg-white rounded-xl shadow-md p-4 sm:p-6">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-sm text-slate-500">
                    ...
                    zaufanie i satysfakcję naszych klientów. Pani Gabriela
                    Muskala osobiście się o tym przekonała!
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center bg-white rounded-xl shadow-md p-4 sm:p-6">
                ...
                <div className="mt-4 text-center">
                  ...
                  <p className="text-sm text-slate-500">
                    Biuro CKDOM zostało wyróżnione podczas prestiżowej gali
                    Lider Nieruchomości Otodom 2020 za najlepszy wynik
                    sprzedażowy w 2020 roku. To dowód uznania dla naszego
                    zaangażowania, skuteczności i zaufania, jakim obdarzyli nas
                    klienci.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="border-t border-slate-700 mt-6 sm:mt-8 pt-6 sm:pt-8 text-center text-slate-400">
              <p className="text-xs sm:text-sm">
                &copy; 2025 Sylwester Pawlik - CKDom. Wszystkie prawa
                zastrzeżone.
              </p>
            </div>
          </div>
